    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new ShoppingCartVM()
            {
                ...
                ListCart = _unitOfWork.ShoppingCart.GetAll(
                    x => x.ApplicationUserId == Claim.Value, pro: "Product"),
        ...
        public IActionResult SummaryPost()
        {
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0)
            {
                ...
                _unitOfWork.OrderHeader.UpdateStripe(ShoppingCartVM.OrderHeader.Id, session.Id, session.PaymentIntentId);
                _unitOfWork.Save();
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            { 
                ...
                {
                    _unitOfWork.OrderHeader.UpdateStripe(id, session.Id, session.PaymentIntentId);
        ...
        public double Getprice(double quantity, double price, double price50, double price100)
        {
            if (quantity <= 50)
            {
                return price;
